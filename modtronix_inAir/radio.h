...
/*!
 *    Type of the supported board. [BOARD_INAIR4 / BOARD_INAIR9]
 */
enum BoardTypeInAir
{
    BOARD_INAIR4 = 0,
...
public:
     ...
     * Return board type
     *
     * @return Returns a BOARD_XXX define
     */
    virtual uint8_t GetBoardType( void ) = 0;
     ...
     */
    virtual void SetBoardType( uint8_t boardType) = 0;
